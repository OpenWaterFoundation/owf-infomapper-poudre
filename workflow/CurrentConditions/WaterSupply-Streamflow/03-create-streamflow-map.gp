...
AddGeoLayerViewToGeoMap(GeoLayerID="MapBoxTopographicLayer",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="MapBoxTopographicLayerView",Name="Topographic (MapBox)",Description="Topographic Map",Properties="selectedInitial: false")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriDarkGray",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriDarkGrayView",Name="Dark Gray (Esri)",Description="Dark Gray background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriImagery",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriImageryView",Name="Imagery (Esri)",Description="Imagery background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriLightGray",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriLightGrayView",Name="Light Gray (Esri)",Description="Light Gray background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriNationalGeographic",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriNationalGeographicView",Name="National Geographic (Esri)",Description="National Geographic background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriShadedRelief",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriShadedReliefView",Name="Shaded Relief (Esri)",Description="Terrain background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriStreets",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriStreetsView",Name="Streets (Esri)",Description="Streets background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriTerrain",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriTerrainView",Name="Terrain (Esri)",Description="Terrain background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriTopographic",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriTopographicView",Name="Topographic (Esri)",Description="Topographic background map from Esri.",Properties="selectedInitial: false")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleSatellite",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleSatelliteView",Name="Satellite (Google)",Description="Satellite background map from Google.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleStreets",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleStreetsView",Name="Streets (Google)",Description="Streets background map from Google.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleHybrid",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleHybridView",Name="Streets & Satellite (Google)",Description="Streets & satellite background map from Google.",Properties="selectedInitial: true")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleTerrain",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleTerrainView",Name="Terrain (Google)",Description="Terrain background map from Google.",Properties="selectedInitial: false")
# Other
...
AddGeoLayerViewToGeoMap(GeoLayerID="USGSTopo",GeoMapID="StreamflowMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="USGSTopoView",Name="USGS Topo (USGS)",Description="USGS Topo background map from USGS.",Properties="selectedInitial: false")
# = = = = = = = = = =
...
AddGeoLayerViewGroupToGeoMap(GeoMapID="StreamflowMap",GeoLayerViewGroupID="WaterDistrictsGroup",Name="CO DWR Water Districts",Description="Water District boundaries from the Colorado Division of Water Resources.",Properties="selectedInitial: true",InsertPosition="Top")
AddGeoLayerViewToGeoMap(GeoLayerID="WaterDistrictLayer",GeoMapID="StreamflowMap",GeoLayerViewGroupID="WaterDistrictsGroup",GeoLayerViewID="WaterDistrictLayerView",Name="CO DWR Water District 3",Description="Water District 3 boundary from the Colorado Division of Water Resources",InsertPosition="Top")
SetGeoLayerViewCategorizedSymbol(GeoMapID="StreamflowMap",GeoLayerViewGroupID="WaterDistrictsGroup",GeoLayerViewID="WaterDistrictLayerView",Name="Colorize district",Description="Show Water District 3 in black.",ClassificationAttribute="DISTRICT",Properties="classificationFile:layers/co-dwr-water-district-3-classify-district.csv")
# = = = = = = = = = =
...
AddGeoLayerViewToGeoMap(GeoLayerID="StreamReachesLayer",GeoMapID="StreamflowMap",GeoLayerViewGroupID="StreamReachesGroup",GeoLayerViewID="StreamReachesLayerView",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches",Properties="highlightEnabled:true")
SetGeoLayerViewSingleSymbol(GeoMapID="StreamflowMap",GeoLayerViewGroupID="StreamReachesGroup",GeoLayerViewID="StreamReachesLayerView",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches",Properties="color:#6297f7,width:2")
#SetGeoLayerViewSingleSymbol(GeoMapID="StreamflowMap",GeoLayerViewGroupID="StreamReachesGroup",GeoLayerViewID="StreamReachesLayerView",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches")
...
AddGeoLayerViewToGeoMap(GeoLayerID="DiversionLayer",GeoMapID="StreamflowMap",GeoLayerViewGroupID="DiversionGroup",GeoLayerViewID="DiversionLayerView",Name="Poudre Diversions",Description="Poudre Diversions",Properties="docPath:'layers/diversions.md'")
# For now use single symbol
# - TODO smalers 2020-05-22 need to enable a graduated symbol based on flow value
SetGeoLayerViewSingleSymbol(GeoMapID="StreamflowMap",GeoLayerViewGroupID="DiversionGroup",GeoLayerViewID="DiversionLayerView",Name="Poudre Diversions",Description="Poudre Diversions",Properties="symbolShape:Square,color:black,fillColor:black,symbolSize:4,sizeUnits:pixels,opacity:1.0,fillOpacity:1.0,weight:1.5")
...
AddGeoLayerViewToGeoMap(GeoLayerID="StreamflowLayer",GeoMapID="StreamflowMap",GeoLayerViewGroupID="StreamflowGroup",GeoLayerViewID="StreamflowLayerView",Name="Poudre Streamflow",Description="Poudre Streamflow",Properties="docPath:'layers/streamgages.md'")
# For now use single symbol
# - TODO smalers 2020-05-22 need to enable a graduated symbol based on flow value
SetGeoLayerViewSingleSymbol(GeoMapID="StreamflowMap",GeoLayerViewGroupID="StreamflowGroup",GeoLayerViewID="StreamflowLayerView",Name="Poudre Streamflow",Description="Poudre Streamflow",Properties="symbolShape:Circle,color:black,fillColor:red,symbolSize:4,sizeUnits:pixels,opacity:1.0,fillOpacity:1.0,weight:1.5")
