...
SetGeoLayerViewSingleSymbol(GeoLayerViewID="DWROfficesLayerView",Name="Use marker image for DWR offices",Description="Use marker image for DWR offices",Properties="symbolImage:/img/office-building.png")
# = = = = = = = = = =
