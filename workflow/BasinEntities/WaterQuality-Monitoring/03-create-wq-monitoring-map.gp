...
AddGeoLayerViewToGeoMap(GeoLayerID="MapBoxSatelliteLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="MapBoxSatelliteLayerView",Name="Satellite (MapBox)",Description="Satellite background map from MapBox.",Properties="selectedInital: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="MapBoxStreetsLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="MapBoxStreetsLayerView",Name="Streets (MapBox)",Description="Streets background map from MapBox.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="MapBoxTopographicLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="MapBoxTopographicLayerView",Name="Topographic (MapBox)",Description="Topographic Map",Properties="selectedInitial: false")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriDarkGray",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriDarkGrayView",Name="Dark Gray (Esri)",Description="Dark Gray background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriImagery",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriImageryView",Name="Imagery (Esri)",Description="Imagery background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriLightGray",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriLightGrayView",Name="Light Gray (Esri)",Description="Light Gray background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriNationalGeographic",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriNationalGeographicView",Name="National Geographic (Esri)",Description="National Geographic background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriShadedRelief",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriShadedReliefView",Name="Shaded Relief (Esri)",Description="Terrain background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriStreets",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriStreetsView",Name="Streets (Esri)",Description="Streets background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriTerrain",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriTerrainView",Name="Terrain (Esri)",Description="Terrain background map from Esri.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="EsriTopographic",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="EsriTopographicView",Name="Topographic (Esri)",Description="Topographic background map from Esri.",Properties="selectedInitial: false")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleSatellite",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleSatelliteView",Name="Satellite (Google)",Description="Satellite background map from Google.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleStreets",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleStreetsView",Name="Streets (Google)",Description="Streets background map from Google.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleHybrid",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleHybridView",Name="Streets & Satellite (Google)",Description="Streets & satellite background map from Google.",Properties="selectedInitial: false")
...
AddGeoLayerViewToGeoMap(GeoLayerID="GoogleTerrain",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="GoogleTerrainView",Name="Terrain (Google)",Description="Terrain background map from Google.",Properties="selectedInitial: false")
# Other
...
AddGeoLayerViewToGeoMap(GeoLayerID="USGSTopo",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="BackgroundGroup",GeoLayerViewID="USGSTopoView",Name="USGS Topo (USGS)",Description="USGS Topo background map from USGS.",Properties="selectedInitial: true")
# = = = = = = = = = =
...
AddGeoLayerViewGroupToGeoMap(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterDistrictsGroup",Name="CO DWR Water Districts",Description="Water District boundaries from the Colorado Division of Water Resources.",Properties="selectedInitial: true",InsertPosition="Top")
AddGeoLayerViewToGeoMap(GeoLayerID="WaterDistrictLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterDistrictsGroup",GeoLayerViewID="WaterDistrictLayerView",Name="CO DWR Water District 3",Description="Water District 3 boundary from the Colorado Division of Water Resources",InsertPosition="Top")
SetGeoLayerViewCategorizedSymbol(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterDistrictsGroup",GeoLayerViewID="WaterDistrictLayerView",Name="Colorize district",Description="Show Water District 3 in black.",ClassificationAttribute="DISTRICT",Properties="classificationFile:layers/co-dwr-water-district-3-classify-district.csv")
# = = = = = = = = = =
...
AddGeoLayerViewGroupToGeoMap(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="StreamReachesGroup",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches",Properties="selectedInitial: true",InsertPosition="Top")
AddGeoLayerViewToGeoMap(GeoLayerID="StreamReachesLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="StreamReachesGroup",GeoLayerViewID="StreamReachesLayerView",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches",Properties="highlightEnabled:true")
SetGeoLayerViewSingleSymbol(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="StreamReachesGroup",GeoLayerViewID="StreamReachesLayerView",Name="Poudre Stream Reaches",Description="Poudre Stream Reaches",Properties="color:#6297f7")
# = = = = = = = = = =
...
AddGeoLayerViewGroupToGeoMap(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",Name="Water Quality Monitoring",Description="Water Quality Monitoring",Properties="selectedInitial: true",InsertPosition="Top")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="WaterQualityMainStemBasinLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualityMainStemBasinLayerView",Name="Main Stem Monitoring Basin (Upper Poudre)",Description="Poudre main stem monitoring basin from Fort Collins Utilities",Properties="docPath:'layers/wq-monitoring-mainstem-basin.md'",InsertPosition="Top")
SetGeoLayerViewCategorizedSymbol(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualityMainStemBasinLayerView",Name="Colorize main stem",Description="",ClassificationAttribute="HU_12_NAME",Properties="classificationFile:layers/wq-monitoring-mainstem-basin-classify-hu12name.csv")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="WaterQualityNorthForkBasinLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualityNorthForkBasinLayerView",Name="North Fork Monitoring Basin (Upper Poudre)",Description="Poudre North Fork monitoring basin from Fort Collins Utilities",Properties="docPath:'layers/wq-monitoring-northfork-basin.md'",InsertPosition="Top")
SetGeoLayerViewCategorizedSymbol(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualityNorthForkBasinLayerView",Name="Colorize North Fork",Description="",ClassificationAttribute="HU_12_NAME",Properties="classificationFile:layers/wq-monitoring-northfork-basin-classify-hu12name.csv")
#
...
AddGeoLayerViewToGeoMap(GeoLayerID="WaterQualitySitesLayer",GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualitySitesLayerView",Name="Poudre Water Quality Monitoring Sites",Description="Poudre water quality monitoring sites for upper and lower Poudre, from Fort Collins Utilities",Properties="docPath:'layers/wq-monitoring-sites.md'",InsertPosition="Top")
# For now use single symbol
SetGeoLayerViewSingleSymbol(GeoMapID="WaterQualityMonitoringMap",GeoLayerViewGroupID="WaterQualityMonitoringGroup",GeoLayerViewID="WaterQualitySitesLayerView",Name="Poudre monitoring",Description="Poudre monitoring",Properties="symbolShape:Circle,color:black,fillColor:black,symbolSize:4,sizeUnits:pixels,opacity:1.0,fillOpacity:1.0,weight:1.5")
# = = = = = = = = = =
